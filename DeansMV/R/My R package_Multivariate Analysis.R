...
#' @param cor_values numeric, a vector specifying the unique values in
#' the lower triangle of the correlation matrix, excluding the diagonal.
#' @return Matrix of multivariate dataset. 
#' @examples 
...
#' @export
simulate_multivariate_data <- function(n, means, cor_values) {
  set.seed(1)
  p <- length(means)
